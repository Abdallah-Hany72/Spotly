...
export default function MoodFilter({ selected = [], onChange }) {
  const moods = ["Quiet", "Energetic", "Romantic", "Productive"];
  ...
  return (
    <div className="space-y-2">
      <span className="text-sm font-semibold text-on-surface">Mood</span>
